...
module on_chip_memory_36K #(
	parameter IP_TYPE 		= "OCMGEN",
	parameter IP_VERSION 	= 32'h1, 
	parameter IP_ID 		= 32'h26c3807
)
(    input  wire    [9:0] addr_A,
    input  wire   [35:0] din_A,
...
RS_TDP36K #(
	.INIT_i(36864'd0),
	.MODE_BITS(81'b11011011011000000000000000000000000000000110110110110000000000000000000000000000)
) RS_TDP36K (
	.ADDR_A1({addr_A_1[9:0], {5{1'd0}}}),
	.ADDR_A2({addr_A_1[9:0], {5{1'd0}}}),
	.ADDR_B1({addr_B_1[9:0], {5{1'd0}}}),
	.ADDR_B2({addr_B_1[9:0], {5{1'd0}}}),
	.BE_A1(2'd3),
	.BE_A2(2'd3),
	.CLK_A1(sys_clk),
	.CLK_A2(sys_clk),
	...
	.REN_B1(ren_B_1),
	.REN_B2(ren_B_1),
	.WDATA_A1(din_A_1[17:0]),
	.WDATA_A2(din_A_1[35:18]),
	.WEN_A1(wen_A1),
	.WEN_A2(wen_A1),
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-12-06 15:32:07.
//------------------------------------------------------------------------------
