...
TDP_RAM36K #(
	.INIT({32768'b10101111100010101010111110001010}),
	.INIT_PARITY({4096'b0101}),
	.READ_WIDTH_B(6'd36),
	.WRITE_WIDTH_A(6'd36)
) SDP_MEM (
	...
	.CLK_B(sys_clk),
	.REN_B(ren_B_1),
	.WDATA_A({din_A_1[34:27], din_A_1[25:18], din_A_1[16:9], din_A_1[7:0]}),
	.WEN_A(wen_A_1),
	.WPARITY_A({din_A_1[35], din_A_1[26], din_A_1[17], din_A_1[8]}),
