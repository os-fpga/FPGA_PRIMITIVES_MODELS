...
module on_chip_memory_18KX2 #(
	parameter IP_TYPE 		= "OCMGEN",
	parameter IP_VERSION 	= 32'h1, 
	parameter IP_ID 		= 32'h2dcbc24
)
...
assign sys_clk = clk;
assign dout_B_1[17:0] = {bram_out_B[17], bram_out_B[15:8], bram_out_B[16], bram_out_B[7:0]};


TDP_RAM18KX2 # (
    .INIT1(16384'b1110001010110010),
    .INIT1_PARITY(2048'b1011),
    .WRITE_WIDTH_A1(18),
    .WRITE_WIDTH_B1(18),
    .READ_WIDTH_A1(18),
    .READ_WIDTH_B1(18)
